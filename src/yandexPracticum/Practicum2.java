...
import java.util.Scanner;
 ...
 class Praktikum2 {
    ...
    public static void main(String[] args) {
        ...
        correctExpenses (salary,
                        transportMoney,
                        foodMoney,
                        savings ); // Вызовите метод correctExpenses с правильными аргументами
    ...
    public static void correctExpenses (int salary,
                                       int transportMoney,
                                       int foodMoney,
                                       int savings) { // Объявите метод correctExpenses
